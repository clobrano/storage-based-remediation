...
// +kubebuilder:rbac:groups=remediation.medik8s.io,resources=sbdconfigs,verbs=get;list;watch
// +kubebuilder:rbac:groups=remediation.medik8s.io,resources=sbdconfigs/status,verbs=get
// +kubebuilder:rbac:groups=remediation.medik8s.io,resources=storagebasedremediations,verbs=get;list;watch;update;patch
// +kubebuilder:rbac:groups=remediation.medik8s.io,resources=storagebasedremediations/status,verbs=get;update;patch
